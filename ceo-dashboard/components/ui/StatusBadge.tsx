...
const STATUS_MAP: Record<string, { text: string; bg: string; label?: string }> = {
  ...
  pending_approval: { text: "#e8963f", bg: "#e8963f22", label: "NEEDS APPROVAL" },
  pending_hitl:   { text: "#e8963f", bg: "#e8963f22", label: "NEEDS APPROVAL" },
  loaded_unactivated: { text: "#7ea6f5", bg: "#5b8def22", label: "LOADED" },
  activated:      { text: "#6fce8f", bg: "#6fce8f22" },
  retired:        { text: "#9aa2ab", bg: "#2a2a2a" },
