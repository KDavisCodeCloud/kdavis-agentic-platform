...
export function AgentRosterCard({ name, status, lastRun, focus, output }: AgentRosterCardProps) {
  return (
    <div
    ...
    >
      <div className="flex items-start justify-between gap-2 mb-1.5">
        <p className="text-[13px] font-bold min-w-0 truncate-text" style={{ color: "#eef2f5" }}>
          {name}
        </p>
      ...
      {output && (
        <p className="text-[11px] font-mono mt-1.5" style={{ color: "#8b96a3" }}>
          {output}
        </p>
      )}
    </div>
