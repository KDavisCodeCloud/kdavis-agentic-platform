...
def _mock_image_generation():
    """2026-09-21: both the active-stage (generate_product_launch_post)
    and warming-stage paths covered here now generate a real image at
    draft time (see test_mkt_li1_asset_vault_wiring.py) — mock it so
    these tests keep covering just the stage-gate logic."""
