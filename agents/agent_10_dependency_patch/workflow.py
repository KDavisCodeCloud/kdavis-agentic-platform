...
class DependencyPatchWorkflow(BaseAgent):
    ...
    def __init__(
        ...
        aws_session=None,  # unused -- Agent 10 has no AWS path; accepted for uniform **creds spreading
        azure_access_token: Optional[str] = None,  # unused -- Agent 10 has no Azure path; accepted for uniform **creds spreading
        azure_devops_token: Optional[str] = None,  # Phase 2 -- routed into DependencyPatchTools' get_repo_tools() provider selection
