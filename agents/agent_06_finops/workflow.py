...
class FinOpsWorkflow(BaseAgent):
    ...
    def __init__(
        ...
        azure_devops_token: Optional[str] = None,  # unused -- Agent 06 has no repo path; accepted for uniform **creds spreading
        azure_devops_org: Optional[str] = None,  # unused -- Agent 06 has no repo path; accepted for uniform **creds spreading
